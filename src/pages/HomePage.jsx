...
const HomePage = () => {
    const quickStartSteps = [
        ...
        },
        {
            ...
            description:
                'Изучите практические примеры использования каждого хука',
            link: '/examples',
        },
        {
            step: '3',
    ...
    const features = [
        ...
        },
        {
            ...
            description:
                'Проверенные паттерны и рекомендации по использованию хуков',
            bgColor:
                ...
                <div className='relative container-wide section-spacing-lg'>
                    <div className='text-center'>
                        ...
                        <h1 className='text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-6 animate-slide-up'>
                            Изучайте{' '}
                            <span className='text-gradient'>React Hooks</span>
                        </h1>
                        ...
                        <p className='text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-10 max-w-4xl mx-auto leading-relaxed animate-slide-up'>
                            Полное руководство по современным React хукам с
                            практическими примерами, лучшими практиками и
            ...
            <div className='container-wide section-spacing'>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                        Следуйте этим простым шагам, чтобы начать изучение React
                        Hooks
                    </p>
                </div>
                ...
                <div className='container-wide'>
                    <div className='text-center'>
                        ...
                        <p className='text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto'>
                            Присоединяйтесь к тысячам разработчиков, которые уже
                            освоили React Hooks с нашим руководством
                        </p>
                        <Link
                            to='/hooks'
                            className='btn-primary text-lg px-8 py-4 group'>
