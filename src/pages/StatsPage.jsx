            ...
            <div className="stats-card">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Ваш прогресс по useContext составляет 78%. Рекомендуем больше
                  практики с этим хуком.
                </p>
              </div>
            </div>
            <div className="stats-card">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Вы готовы к более сложным задачам. Попробуйте комбинировать
                  несколько хуков в одном компоненте.
                </p>
              </div>
            </div>
            <div className="stats-card">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Примените полученные знания в реальном проекте. Это поможет
                  закрепить навыки.
                </p>
              </div>
            </div>
